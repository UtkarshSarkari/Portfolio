    ...
    <div className="w-screen my-20 h-auto flex items-center justify-center">
      <div className="w-3/4">
        ...
        <div className="flex flex-wrap items-center">
          ...
          <Link href="#" className="text-sm sm:text-[15px]  rounded-md px-[2px] py-[2px] bg-gradient-to-r from-emerald-500 to-cyan-600 font-semibold  hover:scale-[1.02] my-4">
          ...
          <Link href="#" className="text-sm sm:text-[15px]  rounded-md px-[2px] py-[2px] bg-gradient-to-r from-emerald-500 to-cyan-600 font-semibold  hover:scale-[1.02]">

            <div className="bg-black rounded-md px-5 py-2 hover:bg-gradient-to-r hover:from-emerald-500 hover:to-cyan-600 flex items-center justify-between">
              Contact Me
